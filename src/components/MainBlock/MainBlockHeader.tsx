...
const MainBlockHeader: FC<MainBlockHeaderProps> = ({
	days,
	day,
	week,
	weeks,
	...
	return (
		<div className="flex justify-around fixed top-[100px] bg-background pt-[10px] pb-[10px] w-[100%]">
			<Dropdown value={day.toString()} onChange={setDay} label="Day" options={days} />
			<Dropdown value={week.toString()} onChange={setWeek} label="Week" options={weeks} />
			<Dropdown
